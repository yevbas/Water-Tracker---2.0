...
struct ProgressCircle: View {
    ...
    var foregroundColors: [Color] = [.blue, .green]
            ...
            ZStack {
                ...
                if getShowShadow(frame: geometry.size) {
                    Circle()
                        ...
                        .shadow(color: ProgressCircle.ShadowColor,
                                radius: ProgressCircle.ShadowRadius,
    ...
    private func getEndCircleShadowOffset() -> (CGFloat, CGFloat) {
        ...
        let xOffset = relativeXOffset.toCGFloat() * ProgressCircle.ShadowOffsetMultiplier
        let yOffset = relativeYOffset.toCGFloat() * ProgressCircle.ShadowOffsetMultiplier
